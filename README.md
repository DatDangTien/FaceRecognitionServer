...
| Metric | CPU - C++ DNN | QCS8550 CPU - C++ DNN | CPU - Python PyTorch | QCS8550 CPU - Python PyTorch | GPU - C++ DNN | GPU - Python PyTorch |
|--------|---------------|----------------------|----------------------|----------------------|---------------|---------------------|
| **Latency ms** | 80 | 120 | 210 | 400 |  |  |
| **FPS** | 12-13 | 8-9 | 4-5 | 2-3 |  |  |
